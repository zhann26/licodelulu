...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{ asset('assets/images/logo.jpg') }}" alt=""
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route ('overdues') }}" class="nav-item nav-link"><i
                            class="fa fa-keyboard me-2"></i>Overdues</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-success sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{ asset('assets/images/logo.jpg') }}" alt=""
                                style="width: 40px; height: 40px;">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Overdues List</h1>
            ...
            <div class="overflow-x-auto">
                <table>
                    ...
                    <tbody>
                        ...
                        @if($overdues->status == 'overdues')
                        <tr>
                            <td>{{ $overdues->locker_number }}</td>
                            <td>{{ $occupant->date_rented }}</td>
                            <td>{{ $occupant->date_ended }}</td>
                            <td>{{ $occupant->amount }}</td>
